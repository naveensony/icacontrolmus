...
<br>
<p>
Your music teacher {{$tname}} has indicated to us here at Musika that you have had your initial lesson and that all went very well. 
{{$tname}} as well as the Musika staff would like to invite you to join our program. 
...
<ul>
	...
	@if(!$isPackage)$ {{($prices['price_30'])}} a lesson for 30 minute lessons, $ {{($prices['price_45'])}} a lesson for 45 minute lessons, and $ {{($prices['price_60'])}}a lesson for 60 minute lessons @else
	${{($prices['price_30']+8*$prices['price_45'])}}for a package of eight 45 minute lessons + 30 minute intro lesson and $ {{($prices['price_30']+8*$prices['price_60'])}} for a package of eight 60 minute lessons + 30 minute intro lesson
