...
Your Music Lessons with {{$tname}}<br />

<div>

<p>Dear {{$student_name}} and/or parents of {{$student_name}},</p>

<p>

Your Musika teacher {{$tname}} has indicated to us here at Musika that {{$student_name}} wishes to stop lessons.
...
<p>Termination reason:  {{$termination_reason}}</p>
<p>
