...
<link rel="stylesheet" href="{{asset('css/jquery-confirm.min.css')}}">
 ...
 <link rel="stylesheet" type="text/css" href="{{asset('css/videopopup.css')}}" media="screen" />
 <style>
 video {
...
.loader 
{
 ...
 height: 100%;
 z-index: 9999;
 background: url('{{asset('img/ajax-loader2.gif')}}') 50% 50% no-repeat rgb(249,249,249);
}	
.fa-stack {
...
<div class="wrapper wrapper-content animated fadeInRight">
	<div class="row">
			...
			<div class="ibox">
				...
				@if(!empty($error_msg)  )
				 ...
				 <div class="ibox-content">
					...
					@if(!empty($_COOKIE['myCookie']) && $_COOKIE['myCookie'] == 'profileUpdate')
					...
					@endif
					<br/><br/>
					<ul>  @if(isset($error_msg['instrument']) && $error_msg['instrument']==0) <li> You must select at least 1 instrument. </li> @endif 
					 @if(isset($error_msg['style']) && $error_msg['style']==0) <li> You must select at least 1 style.</li> @endif
					 @if(isset($error_msg['training']) && $error_msg['training']==0) <li> Degrees and Education can not be blank.</li> @endif
					 @if(isset($error_msg['avatar']) && $error_msg['avatar']==0) <li>You did not upload a profile picture. A profile picture is required.</li> @endif
					 @if(isset($error_msg['aboutTeacher']) && $error_msg['aboutTeacher']==0) <li>You must enter at least 500 characters in About me.</li> 
					 @elseif(isset($error_msg['aboutTeacher']) && $error_msg['aboutTeacher']==1)
						 <li>You should enter at least 500 characters in About me</li> 
					 @endif
					 @if(isset($error_msg['experience']) && $error_msg['experience']==0) <li>You must enter at least 500 characters in Experience.</li> 
					 @elseif(isset($error_msg['experience']) && $error_msg['experience']==1)
						 <li>You should enter at least 500 characters in Experience</li> 
					 @endif
					 @if(isset($error_msg['methodsUsed']) && $error_msg['methodsUsed']==0) <li>You must enter at least 500 characters in Methods.</li> 
					 @elseif(isset($error_msg['methodsUsed']) && $error_msg['methodsUsed']==1)
						 <li>You should enter at least 500 characters in Methods</li>
					 @endif
					 @if(isset($error_msg['lessonsStyle']) && $error_msg['lessonsStyle']==0) <li>You must enter at least 500 characters in Teaching style.</li> 
					 @elseif(isset($error_msg['lessonsStyle']) && $error_msg['lessonsStyle']==1)
						 <li>You should enter at least 500 characters in Teaching style.</li>
					 @endif
					 @if(isset($error_msg['homestudios_msg1']) && $error_msg['homestudios_msg1']==0) <li>Please select where you can teach.</li> @endif
					 @if(isset($error_msg['teacherSchedule']) && $error_msg['teacherSchedule']==0) <li>You must select at least 1 Teacher Schedule.</li> @endif
					 @if(isset($error_msg['homeLocationMsg']) && $error_msg['homeLocationMsg']==0) <li>You have selected "Yes" to teaching in home lessons. Therefore you must either 1) create at travel boundary, or 2) change your selection to "No" for teaching in home lessons.</li> @endif
					 @if(isset($error_msg['studioLocationMsg']) && $error_msg['studioLocationMsg']==0) <li>You have selected "Yes" to teaching in your studio. Therefore you must either 1) mark your studio location, or 2) change your selection to "No" for teaching in your studio.</li> @endif
					 @if(isset($error_msg['teachesHomeMsg']) && $error_msg['teachesHomeMsg']==0) <li>Please select "Yes" or "No" for teaching in home lessons.</li> @endif
					 @if(isset($error_msg['teachesStudioMsg']) && $error_msg['teachesStudioMsg']==0) <li>Please select "Yes" or "No" for teaching in your studio.</li> @endif
					 @if(isset($error_msg['OnlineTeacherMsg']) && $error_msg['OnlineTeacherMsg']==0) <li>Please select "Yes" or "No" for online lesson of teach section.</li> @endif
					 </ul>
					</div>
				</div>
				@else
				...
				<div class="ibox-content wizard-big">
					<form id="form" >
					<fieldset>
						@if($teaches['profileApprove']==1 && $teaches['accountApprove']==1)
						<div class="row">
							...
							<strong><a href="https://www.musikalessons.com/teachers/{{$teaches['urlName']}}" > https://www.musikalessons.com/teachers/{{$teaches['urlName']}} </a> </strong></br>
						...
						<div class="row">
							...
							@endphp
							<b>Name:</b> {{$teaches['firstName']}}  {{$teaches['lastName']}}  &nbsp;&nbsp;&nbsp;&nbsp;<b>Zip Code:</b> {{$teaches['postalCode']}}
							</br>
							
							<b>Your Profile Completeness:</b> <b style="color:#6c116c">{{$completenss[$profileCmp]}}</b> <span class="name_zip1"><a id="what-does-it-mean" data-toggle="modal" data-target="#table-modal">What does it mean?</a></span>
						</div>
						<div class="row">
							<div class="mob-badge">
								<a data-toggle="modal" data-target="#table-modal">
								<div class="col-md-2 col-md-offset-1  @if($teaches['profile_completenss']=='Incomplete' ) bold bg-red @else bg-blue @endif  badge">Incomplete</div>
								<div class="col-md-2 @if($teaches['profile_completenss']=='Basic' ) bold bg-purpel @else bg-blue @endif badge">70%</div>
								<div class="col-md-2  @if($teaches['profile_completenss']=='Preferred' ) bold bg-purpel @else bg-blue @endif badge">80%</div>
								<div class="col-md-2  @if($teaches['profile_completenss']=='Select' ) bold bg-purpel @else bg-blue @endif badge">90%</div>
								<div class="col-md-2  @if($teaches['profile_completenss']=='Elite' ) bold bg-purpel @else bg-blue @endif badge">100%</div>
								</a>
							</div>
						</div>
						<br/>
								...
								<div class="col-md-3" style="width: !important">
									<div class="text-center" style="border-style: none; !important">
										...
										@if(Auth::check() )
											...
											@endphp
											@if($avatar->teacherId->avatar!='')
												<img id="profileimage"  alt="image" width="190px"  src="https://musikalessons.com/uploads/TeachersModel/{{$avatar->teacherId->id}}/avatar/{{$newavt}}">
												<input type="hidden" name="oldImagePath" id="oldImagePath" value="{{$newavt}}">
												
											@else
												<img id="profileimage"  alt="image" width="190px"  src="{{url('img/profile.png')}}">
											@endif	
										@else
											<img id="profileimage" alt="image" width="190px"  src="{{url('img/profile.png')}}">
										 @endif
										...
										@if($teaches['avatar']!='')
											...
											<a class="btn btn-xs btn-primary" onclick="deleteProfile('{{$teaches['avatar']}}');"><i class="fa fa-trash"></i> Delete</a>
						...
						<fieldset>
							...
							@endphp
							@foreach($instruments as $ins_data)
								<div class="col-xs-6 col-md-3"><label class="checkbox-container"> {{ $ins_data->name }}<input value="{{ $ins_data->id }}" id="instruments_0" type="checkbox" name="instruments[]" @if(isset($insturmentIds) && in_array($ins_data->id, $insturmentIds))
							{{"checked"}} @endif /> <span class="checkmark"></span> </label></div>
							@endforeach	
		...
		<div class="row">
				...
				<div class="col-md-12" style="padding-left: 0px;">	
					...
					<input value="no" name="online_lessons" id="online_lessons" type="radio"  <?php if($teaches['teachesOnline']=="no"){ echo "checked='checked'";  } ?> >  No </div>
						...
						<div id="tab-2" class="">
							<div class="panel-body">
								<fieldset class="form-horizontal">
			<div id="tmap" class="each_catagory" style="display: @if(isset($styleHome)){{$styleHome}} @else none @endif">
			...
			<div class="each_details">
				...
				<div style="position:relative;  height:550px;">
					<div id='myMap' style="position:relative; "> 
						...
						<div class="overlay">
							<div class="overlay-content"><img src="{{asset('img/ajax-loader2.gif')}}" alt="Loading..."/>
							</div>
						</div>
					</div>
			...
			<div id="smap" class="each_catagory" style="display: @if(isset($styleStudio)){{$styleStudio}} @else none @endif ">
  ...
  <strong class="fa-stack-1x text-default" style="color:white">6</strong>
		...
		@endphp
		@foreach($stylesList as $style_data)
		<div class="col-xs-6 col-md-3"><label class="checkbox-container">{{$style_data->name}}<input value="{{$style_data->id}}" id="styles_0" type="checkbox" name="styles[]" @if(isset($TeacherStyleIds) && in_array($style_data->id, $TeacherStyleIds))
			{{"checked"}} @endif /> <span class="checkmark"></span> </label></div>
		@endforeach
		</div> 
		</div>
...
<div class="row">
  ...
  <strong class="fa-stack-1x text-default" style="color:white">7</strong>
	...
	@if($teaches['newUser']=='no')
		@php $count=1;  @endphp
		<div class="col-md-12">
			<!--<textarea name="teacherTraining" id="teacherTraining" class="form-control" ></textarea>-->
			<textarea class="form-control" cols="80" id="teacherTraining" name="teacherTraining" rows="20" >{{$teaches['training']}}
			</textarea>
		</div>
	@else
		...
		@php $count=1;  @endphp
		@if($teaches['training']!='')
		@foreach($teaches['training'] as $data)
		<div id="TextBoxDiv{{$count}}" class="col-md-12">
			<div class="col-md-4" >
				<div class="form-group">
				   <select class="form-control" name="TeachersModeltraining{{$count}}" id="TeachersModeltraining{{$count}}" onchange="getDesc({{$count}});" >
						<option value="">Select degree and education</option>
						<option value="Course Work" @if($data['TeachersModeltraining']=="Course Work"){{"selected"}} @endif >Course Work</option>
						<option value="Professional Certificate" @if($data['TeachersModeltraining']=="Professional Certificate"){{"selected"}} @endif>Professional Certificate</option>
						<option value="Teaching Certificate" @if($data['TeachersModeltraining']=="Teaching Certificate"){{"selected"}} @endif>Teaching Certificate</option>
						<option value="Associate Degree" @if($data['TeachersModeltraining']=="Associate Degree"){{"selected"}} @endif>Associate Degree</option>
						<option value="Bachelor Degree" @if($data['TeachersModeltraining']=="Bachelor Degree"){{"selected"}} @endif>Bachelor Degree</option>
						<option value="Graduate Degree" @if($data['TeachersModeltraining']=="Graduate Degree"){{"selected"}} @endif>Graduate Degree</option>
						<option value="Master Degree" @if($data['TeachersModeltraining']=="Master Degree"){{"selected"}} @endif>Master Degree</option>
						<option value="Doctoral Degree" @if($data['TeachersModeltraining']=="Doctoral Degree"){{"selected"}} @endif>Doctoral Degree</option>
						<option value="other" @if($data['TeachersModeltraining']=="other"){{"selected"}} @endif>Other</option>
					</select>
				</div>
			</div>
			<div id=""> <!-- addDesc{{$count}} -->
				<div class="col-md-6" style="padding-left: 0px; !important">
					<div class="form-group"><input type="text" name="degreeSchoolName{{$count}}" id="degreeSchoolName{{$count}}" class="form-control" maxlength="100" placeholder="Name of School" value="{{$data['degreeSchoolName']}}">
					</div>
				</div>	
			</div>
		</div>
		@php $degreeCnt = $count; $count++;  @endphp 
		@endforeach
		@else
		<div id="TextBoxDiv{{$count}}" class="col-md-12">
			<div class="col-md-4" >
		...
		<div class="col-md-12" id="degreeButton">
			<div class="col-md-6">
				<input type="hidden" name="degreeCounter" id="degreeCounter" value="{{$degreeCnt}}" >
  ...
  <strong class="fa-stack-1x text-default" style="color:white">8</strong>
			...
			@if($teaches['newUser']=='no')
				<div class="col-md-12">
					...
					<textarea class="form-control" cols="80" id="teacherDegrees" name="teacherDegrees" rows="20" >{{$teaches['degrees']}}
					</textarea>
				</div>
			@else
			<div class="col-md-6" >
				<div class="form-group">
					<input type="text" name="award_achievement[]" class="form-control" maxlength="100" value="@if(isset($teaches['degrees'][0])){{$teaches['degrees'][0]}}@endif">
				</div>
				<div class="form-group">
					<input type="text" name="award_achievement[]" class="form-control" maxlength="100" value="@if(isset($teaches['degrees'][1])){{$teaches['degrees'][1]}}@endif">
				</div>
				<div class="form-group">
					<input type="text" name="award_achievement[]" class="form-control" maxlength="100" value="@if(isset($teaches['degrees'][2])){{$teaches['degrees'][2]}}@endif">
				</div>
				<div class="form-group">
					<input type="text" name="award_achievement[]" class="form-control" maxlength="100" value="@if(isset($teaches['degrees'][3])){{$teaches['degrees'][3]}}@endif">
				</div>
				<div class="form-group">
					<input type="text" name="award_achievement[]" class="form-control" maxlength="100" value="@if(isset($teaches['degrees'][4])){{$teaches['degrees'][4]}}@endif">
				</div>
			</div>
			@endif
		</div>
    ...
    <!------------------Custom html by v ---------------------------------->
						...
						<div class="row">
							...
							@foreach($teachersPhotos as $photo)
								<div class="col-md-3" style="border: 1px solid; text-align: center;">
								<img alt="photo" src="https://musikalessons.com/uploads/photos/thumb.{{$photo->image}}" height="140px">
								<div style="bottom: 76%; position: absolute;right: 0px;" ><button type="button" class="btn btn-block btn-primary btn-flat galleryDiv{{$photo->id}}" onclick="btnDeleteImage('{{$photo->id}}');">X</button></div>
								</div>
							@endforeach	
							</div>
							<div class="col-md-12">
						...
						<div class="row">
							...
							@if(isset($VideoInfo1->type))
								@if($VideoInfo1->type=='Youtube')
									@php 
									...
									@endphp
									<div class="col-md-8">
										<a href="{{$split_url[0]}}" class="vid-icon bla-2" title="{{$title}}">{{$title}}<span></span></a> 
										<a href="javascript:void(0)" class="vid-rem-icon" onclick="removeVideo('{{$VideoInfo1->id}}','videoId')">Remove</a>	
									</div>
									<div class="col-md-4">
								...
								@else
									...
									<div class="col-md-8" id="welcomeVideoTitle">
										<a href="javascript:void(0)" class="vid-icon" id="video1" title="{{$title}}">{{$title}}<span></span></a> 
										<a href="javascript:void(0)" class="vid-rem-icon" onclick="removeVideo('{{$VideoInfo1->id}}','videoId')">Remove</a>	
									</div>
									<div class="col-md-4">
						...
						<div class="row">
							...
							@if(isset($VideoInfo2->type))
								@if($VideoInfo2->type=='Youtube')
									@php 
									...
									<div class="col-md-8">
										<a href="{{$split_url[0]}}" class="vid-icon bla-2" title="{{$title}}">{{$title}}<span></span></a> 
										<a href="javascript:void(0)" class="vid-rem-icon" onclick="removeVideo('{{$VideoInfo2->id}}','videoId2')">Remove</a>
									</div>
									<div class="col-md-4">
									</div>
								@else
									...
									<div class="col-md-8" id="welcomeVideoTitle2">
										<a href="javascript:void(0)" class="vid-icon" id="video11" title="{{$title}}">{{$title}}<span></span></a>  
										<a href="javascript:void(0)" class="vid-rem-icon" onclick="removeVideo('{{$VideoInfo2->id}}','videoId2')">Remove</a>
									</div>
									<div class="col-md-4">
									</div>
  ...
  <strong class="fa-stack-1x text-default" style="color:white">12</strong>
			...
			<div class="col-md-12">
				<div class="form-group">
				   <textarea name="aboutTeacher" id="aboutTeacher" rows="4" cols="110" class="form-control" >{{$teaches['aboutTeacher']}}</textarea>
				</div>
			</div>
			<div class="col-md-12">
				<div class="form-group">
  ...
  <strong class="fa-stack-1x text-default" style="color:white">13</strong>
			...
			<div class="col-md-12">
				<div class="form-group">
				   <textarea name="experience" id="experience" rows="4" cols="110" class="form-control" >{{$teaches['experience']}}</textarea>
				</div>
			</div>
			<div class="col-md-12">
				<div class="form-group">
  ...
  <strong class="fa-stack-1x text-default" style="color:white">14</strong>
			...
			<div class="col-md-12">
				<div class="form-group">
				   <textarea name="methodsUsed" id="methodsUsed" rows="4" cols="110" class="form-control" >{{$teaches['methodsUsed']}}</textarea>
				</div>
			</div>
			<div class="col-md-12">
				<div class="form-group">
  ...
  <strong class="fa-stack-1x text-default" style="color:white">15</strong>
			...
			<div class="col-md-12">
				<div class="form-group">
				   <textarea name="lessonsStyle" id="lessonsStyle" rows="4" cols="110" class="form-control" >{{$teaches['lessonsStyle']}}</textarea>
				</div>
			</div>
			<div class="col-md-12">
				<div class="form-group">
  ...
  <strong class="fa-stack-1x text-default" style="color:white">16</strong>
				...
				<div class="col-lg-12 foriphone5" >
                    <div class="ibox float-e-margins">
						...
						$k=1;
						@endphp
						@foreach($scheduleArr as $data)
                                <tr class="{{$data[2]}}">
                                    <td Rowspan="3" class="schedule_heading"><strong>{{$data[0]}} </strong></td>
                                    <td><label class="checkbox-container css-home"><span class="scheduleHome"></span> <input id="{{$data[1]}}01" <?php if($schedule_data!='' && $schedule_data[$data[1].'01']==1){ echo "checked"; } ?> class="css-checkbox" type="checkbox"> <span class="checkmark"></span> </label></td>
                                    <td><label class="checkbox-container css-home"><span class="scheduleHome"></span><input id="{{$data[1]}}04" class="css-checkbox" type="checkbox" <?php if($schedule_data!='' && $schedule_data[$data[1].'04']==1){ echo "checked"; } ?> >  <span class="checkmark"></span> </label></td>
                                    <td> <label class="checkbox-container css-home"><span class="scheduleHome"></span><input id="{{$data[1]}}07" class="css-checkbox" type="checkbox" <?php if($schedule_data!='' && $schedule_data[$data[1].'07']==1){ echo "checked"; } ?> > <span class="checkmark"></span> </label>  </td>
                                    <td> <label class="checkbox-container css-home"><span class="scheduleHome"></span><input id="{{$data[1]}}10" class="css-checkbox" type="checkbox" <?php if($schedule_data!='' && $schedule_data[$data[1].'10']==1){ echo "checked"; } ?> >  <span class="checkmark"></span> </label> </td>
                                    <td> <label class="checkbox-container css-home"><span class="scheduleHome"></span><input id="{{$data[1]}}13" class="css-checkbox" type="checkbox" <?php if($schedule_data!='' && $schedule_data[$data[1].'13']==1){ echo "checked"; } ?> >  <span class="checkmark"></span> </label> </td>
                                    <td> <label class="checkbox-container css-home"><span class="scheduleHome"></span><input id="{{$data[1]}}16" class="css-checkbox" type="checkbox" <?php if($schedule_data!='' && $schedule_data[$data[1].'16']==1){ echo "checked"; } ?>  >  <span class="checkmark"></span> </label> </td>
                                    <td> <label class="checkbox-container css-home"><span class="scheduleHome"></span><input id="{{$data[1]}}19" class="css-checkbox" type="checkbox" <?php if($schedule_data!='' && $schedule_data[$data[1].'19']==1){ echo "checked"; } ?> >  <span class="checkmark"></span> </label> </td>
                                    <td>  </td>
                                    <td>  </td>
                                    <td>  </td>
                                    <td>  </td>
                                ...
                                <tr class="{{$data[2]}}">
                                    <td><label class="checkbox-container css-studio"> <span class="scheduleStudio"></span> <input id="{{$data[1]}}02" class="css-checkbox" type="checkbox" <?php if($schedule_data!='' && $schedule_data[$data[1].'02']==1){ echo "checked"; } ?> > <span class="checkmark"></span> </label></td>
                                    <td><label class="checkbox-container css-studio"><span class="scheduleStudio"></span> <input id="{{$data[1]}}05" class="css-checkbox" type="checkbox" <?php if($schedule_data!='' && $schedule_data[$data[1].'05']==1){ echo "checked"; } ?> >  <span class="checkmark"></span> </label></td>
                                    <td><label class="checkbox-container css-studio"><span class="scheduleStudio"></span> <input id="{{$data[1]}}08" class="css-checkbox" type="checkbox" <?php if($schedule_data!='' && $schedule_data[$data[1].'08']==1){ echo "checked"; } ?> >  <span class="checkmark"></span> </label> </td>
                                    <td><label class="checkbox-container css-studio"><span class="scheduleStudio"></span> <input id="{{$data[1]}}11" class="css-checkbox" type="checkbox" <?php if($schedule_data!='' && $schedule_data[$data[1].'11']==1){ echo "checked"; } ?> >  <span class="checkmark"></span> </label> </td>
                                    <td><label class="checkbox-container css-studio"><span class="scheduleStudio"></span> <input id="{{$data[1]}}14" class="css-checkbox" type="checkbox" <?php if($schedule_data!='' && $schedule_data[$data[1].'14']==1){ echo "checked"; } ?> >  <span class="checkmark"></span> </label></td>
                                    <td><label class="checkbox-container css-studio"><span class="scheduleStudio"></span> <input id="{{$data[1]}}17" class="css-checkbox" type="checkbox" <?php if($schedule_data!='' && $schedule_data[$data[1].'17']==1){ echo "checked"; } ?> >  <span class="checkmark"></span> </label></td>
                                    <td><label class="checkbox-container css-studio"><span class="scheduleStudio"></span> <input id="{{$data[1]}}20" class="css-checkbox" type="checkbox" <?php if($schedule_data!='' && $schedule_data[$data[1].'20']==1){ echo "checked"; } ?> >  <span class="checkmark"></span> </label></td>
                                    <td></td>
                                    <td></td>
                                    <td></td>
                                    <td></td>
								...
								<tr class="{{$data[2]}}">
                                    <td><label class="checkbox-container css-online"><span class="scheduleOnline"></span>  <input id="{{$data[1]}}03" class="css-checkbox" type="checkbox" <?php if($schedule_data!='' && $schedule_data[$data[1].'03']==1){ echo "checked"; } ?> > <span class="checkmark"></span> </label></td>
                                    <td><label class="checkbox-container css-online"><span class="scheduleOnline"></span> <input id="{{$data[1]}}06" class="css-checkbox" type="checkbox" <?php if($schedule_data!='' && $schedule_data[$data[1].'06']==1){ echo "checked"; } ?> > <span class="checkmark"></span> </label></td>
                                    <td><label class="checkbox-container css-online"><span class="scheduleOnline"></span> <input id="{{$data[1]}}09" class="css-checkbox" type="checkbox" <?php if($schedule_data!='' && $schedule_data[$data[1].'09']==1){ echo "checked"; } ?> >  <span class="checkmark"></span> </label> </td>
                                    <td><label class="checkbox-container css-online"><span class="scheduleOnline"></span> <input id="{{$data[1]}}12" class="css-checkbox" type="checkbox" <?php if($schedule_data!='' && $schedule_data[$data[1].'12']==1){ echo "checked"; } ?> >  <span class="checkmark"></span> </label> </td>
                                    <td><label class="checkbox-container css-online"><span class="scheduleOnline"></span> <input id="{{$data[1]}}15" class="css-checkbox" type="checkbox" <?php if($schedule_data!='' && $schedule_data[$data[1].'15']==1){ echo "checked"; } ?>>  <span class="checkmark"></span> </label></td>
                                    <td><label class="checkbox-container css-online"><span class="scheduleOnline"></span> <input id="{{$data[1]}}18" class="css-checkbox" type="checkbox" <?php if($schedule_data!='' && $schedule_data[$data[1].'18']==1){ echo "checked"; } ?> > <span class="checkmark"></span> </label></td>
                                    <td><label class="checkbox-container css-online"><span class="scheduleOnline"></span> <input id="{{$data[1]}}21" class="css-checkbox" type="checkbox" <?php if($schedule_data!='' && $schedule_data[$data[1].'21']==1){ echo "checked"; } ?> >  <span class="checkmark"></span> </label></td>
                                    <td></td>
                                    <td></td>
                                    <td></td>
                                    <td></td>
								...
								<tr class="{{$data[2]}}" style="font-weight: bold;">	
									<td></td>
                ...
                <div class="ibox collapsed">
                    ...
                    <div class="ibox-content" style="border-width: 0; ">
						<div class="col-md-12" style="padding-top: 25px;">
							@php $i=0 @endphp
							@foreach($spotlightQuestion as $question)	
								<div class="form-group">
								<strong>{{$question->title}} </strong> </br>
								<span  style="color:#00aeef;cursor:pointer" onclick="$('#each_details_{{$question->Id}}').toggle();" > @if(isset($teacherSpotlight[$i]->qid) && $teacherSpotlight[$i]->answer!='') Edit @else Answer this question. @endif</span>
								   <div id="each_details_{{$question->Id}}" class="each_details" style="display: none;">
								   <textarea name="QuestionsModel[]" id="Question{{$i}}" rows="5" cols="110" class="form-control" onkeydown="checkWordLength({{$i}})">@if(isset($teacherSpotlight[$i]->qid) && $teacherSpotlight[$i]->answer!='') {{$teacherSpotlight[$i]->answer}} @endif</textarea>
								   
								   <span style="color:red" id="questionUsedLimit{{$i}}" >@if(isset($teacherSpotlight[$i]->qid) && str_word_count($teacherSpotlight[$i]->answer)<27) A minimum of 27 words is required. @endif </span>
								   </div>
								</div>
							@php $i++; @endphp	
							@endforeach	
 ...
 <div class="video-pop-up-box" style="display:none">
	<div class="player-box">
		<video width="100%" controls>
		  <source src="{{storage_path('media/Teacher_Welcome.mp4')}}" type="video/mp4">
		</video>
...
<div class="video-pop-up-box2" style="display:none">
	<div class="player-box">
		<video width="100%" controls>
		  <source src="{{storage_path('media/Teacher_Boundary_Map_Final.mp4')}}" type="video/mp4">
		</video>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" style="padding: 0px 8px 0px 8px;"> 
          <!-- Start Of The Table Structure -->
				<p>Your current profile completeness is: {{$completenss[$teaches['profile_completenss']]}}. To reach higher levels, review the profile content requirements. The benefits of each level are also listed below.</p>
			<div id="wrapper">
			<div class="row">
				<div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-content"  style="overflow: auto; " id="table-container" >
                            <table class="table table-hover blue-heading-table" style="font-size: 14px;" id="">
								...
								<tr>
									<td>Reviews:Students can write you a review <a href="https://www.musikalessons.com/teachers/{{$teaches['urlName']}}">here</a> <BR>Share it with them!</td>
									<td></td>
									<td>4+</td>
									<td>6+</td>
									<td>8+</td>
