...
<div class="row border-bottom">
    <nav class="navbar navbar-static-top white-bg" role="navigation" style="margin-bottom: 0;padding-right: 4%;padding-bottom: 10px;">
        ...
        <ul class="nav navbar-top-links navbar-right">
			<li>
                    <span class="m-r-sm text-muted welcome-message">Welcome @if(Auth::check()){{Auth::user()->firstName}}  {{Auth::user()->lastName}} ! @endif</span>
           </li>
            <li>
...
<div class="dd-text"> <span style="background-color: #742475; font-size: 16px;
    font-weight: 500;"> <a href='/paymentMethod' style='font-size: 16px;color:#fff'>New! Sign up for direct deposit!</a> </span></div>