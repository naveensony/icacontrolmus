                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content text-center">
                           ...
                           <video class="video" width="240"   src="{{url('media/Request_Student_New_System_from_swf_to_mp4_same_quality.mp4')}}" type="video/mp4" controls="controls" poster="{{url('media/reqstudent.png')}}">
