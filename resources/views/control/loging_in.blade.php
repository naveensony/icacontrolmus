...
<meta http-equiv="refresh" content="2;URL={{route('control.clock_in')}}" />
<!--[if IE 6]>
...
<div id="admin-wrapper">
  <form action="" method="post">
    <div id="logo">
      <center><h1>Loging in..</h1>
      <img src="{{asset('control/assets/images/loader1.gif')}}" width="128" height="15" border="0" /></center></div>
  </form>
</div>
</body>
</html>
