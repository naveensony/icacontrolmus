...
function View(calendar) {
	...
	t.getCellsPerMonth = getCellsPerMonth;
	...
	(function() {
		...
		for (var dayIndex=0, cellMonthIndex=0; dayIndex<31; dayIndex++) {
			dayToCellMap[dayIndex] = cellMonthIndex;
			isHiddenDayHash[dayIndex] = $.inArray(dayIndex, hiddenDays) != -1;
			if (!isHiddenDayHash[dayIndex]) {
				cellToDayMap[cellMonthIndex] = dayIndex;
				cellMonthIndex++;
			}
		}
	...
	function getCellsPerMonth() {
		return cellsPerMonth;
	}
...
/* A Month view with simple day cells running vertically
--------------------------------------------------------------------------*/

fcViews.vertMonth = VertMonthView; // register this view

function VertMonthView(calendar) {
    BasicView.call(this, calendar); // call the super-constructor
}

VertMonthView.prototype = createObject(BasicView.prototype);
$.extend(VertMonthView.prototype, {
    name: 'vertMonth',
    ...
    render: function(date) {
        ...
        BasicView.prototype.render.call(this, this.getCellsPerMonth(),1,  true);
    }
});
;;
