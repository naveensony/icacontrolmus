...
@if (session('status'))
		...
		<div class="row  paddingzero">
			<form action="{{url('/updateProspective')}}" method='post' onsubmit="return chkForm(this)">
	 {{csrf_field()}}
      <div class="col-lg-12">
                ...
                <table class="table table-striped">
							...
							<th>Last Status</th>
								...
								<tr>
								<td class="status">{{$prospective_students->prospectiveStudent->firstName.' '.$prospective_students->prospectiveStudent->lastName}}</td>
