	...
	**/
	...
	public function confirmation(Request $request)
	{
		...
		$emailIds = ['naveensony02@gmail.com'];
				...
				Mail::to('naveensony02@gmail.com')->send(new \App\Mail\TerminateLesson($details,$sname));
		 if(!Mail::failures())
		 {
		...
		$emailIds = ['naveensony02@gmail.com'];
				...
				Mail::to('naveensony02@gmail.com')->send(new \App\Mail\TerminateLink($details,$sname));
			if(!Mail::failures())
			{ 
