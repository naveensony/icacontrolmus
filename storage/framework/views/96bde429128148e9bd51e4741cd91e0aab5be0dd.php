...
<div id="wrapper" class="login_wrap">
    <div class="middle-box text-center loginscreen animated fadeInDown">
        <div>
            <div>
				<h5> TEACHER LOGIN:</h5>
                <!-- <h1 class="logo-name"><img src="<?php echo e(url('img/logo_img.gif')); ?>"></h1>-->
                <h1 class="logo-name"><!--<img src="<?php echo e(url('img/Musika-logo-2.svg')); ?>" height="135px">--></h1>
            </div>
            <form class="m-t" role="form" method="POST" action="<?php echo e(route('login')); ?>">
			 <input type="hidden" name="_token" id="csrf-token" value="<?php echo e(Session::token()); ?>" />
                ...
                <div class="form-group">
                      <input id="email" type="email" placeholder="E-mail Address" class="form-control b_color" name="email" value="<?php echo e(old('email')); ?>" required autofocus>
				 ...
				 <div class="form-group<?php echo e($errors->has('password') ? ' has-error' : ''); ?>">
                <div class="form-group">
                      <input id="password" placeholder="Password" type="password" class="form-control b_color" name="password" required>
				...
				<div class="form-group">
					<a class="btn btn-link" href="<?php echo e(route('password.request')); ?>">
                                   Lost Your Password? Get it here!
                                </a>
				</div>
				<div class="form-group">
					<input name="remember" type="checkbox" id="remember"> Remember Me
					
					<!--<div class="col-md-6" style="margin-bottom: 8px; margin-top: -6px;">
						<a class="btn btn-link" href="<?php echo e(route('support')); ?>">
                                   Support link!
                                </a>
					</div>-->
				</div>
                ...
                <button type="submit" class="btn-blue block full-width m-b">Login</button>
            </form>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.login_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\musikateachers\resources\views/auth/login.blade.php ENDPATH**/ ?>