...
<?php $__env->startSection('title'); ?> Submit Entry  <?php $__env->stopSection(); ?>
<?php $__env->startSection('link_css'); ?>

<link href="<?php echo e(asset('js/plugins/2.1.1/fullcalendar.css')); ?>" rel='stylesheet' >
<link href="<?php echo e(asset('js/plugins/2.1.1/fullcalendar.print.css')); ?>" rel='stylesheet' media='print'>
 <style>
#myModal label {
					...
					<input type="hidden" name="hidden_event_date" id="hidden_event_date" >
						...
						<div class="col-sm-12">
							<div class="col-sm-1" style="padding-right: 11px; padding-left: 0px;">
								...
								<?php $mnow = date('m'); for($i=1;$i<13;$i++){ ?>	
									<option value="<?php echo sprintf("%02d", $i) ?>" <?php if($mnow==$i): ?> selected <?php endif; ?>><?php echo e($monthNames[$i-1]); ?></option>
								<?php } ?>		
								</select>	         
							</div>
							<div class="col-sm-1" style="padding-left: 4px; padding-right: 13px;">
								...
								<?php $dnow = date('d'); for($i=1;$i<=31;$i++){ ?>
								<option value="<?php echo sprintf("%02d", $i) ?>" <?php if($dnow==$i): ?> selected <?php endif; ?>><?php echo sprintf("%02d", $i) ?></option>
								<?php } ?>
								</select>	         
							</div>
							<div class="col-sm-2 year-width" style="padding-left: 2px;">
								...
								<?php $ynow = date('Y'); for($i=date('Y');$i>2005;$i--){ ?>
								<option value="<?php echo e($i); ?>" <?php if($ynow==$i): ?> selected <?php endif; ?> ><?php echo e($i); ?></option>
								<?php } ?>
								</select>	         
							</div>
							...
							<div class="col-sm-3 student-width">
								...
								<select class="form-control" name="stuName" id="sname" onchange="getInstrumentNamePopup()" <?php if($student_id!=""): ?> disabled <?php endif; ?>>
									<option value="">--</option>
									<?php $__currentLoopData = $studentData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $students): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<option value="<?php echo e($students->studentId); ?>"  <?php if($student_id==$students->studentId): ?> selected <?php endif; ?> ><?php echo e($students->name); ?></option>
							...
							<div class="col-sm-2 inst-width" style="padding-left: 0px;">
								...
								<option value="">--</option>
								<?php if(isset($ins_data) && !empty($ins_data)): ?>
									
								<?php //print_r($ins_data); ?>
								<option value="<?php echo e($ins_data['ins_id']); ?>" selected ><?php echo e($ins_data['ins_name']); ?> </option>
								<?php endif; ?>
								</select>	         
							</div>
						</div>
						...
						<div class="form-group">
                          <div class="col-sm-12">
							...
							<strong>Important Reminder:</strong> (link opens in new window/tab)
								<small><a href="<?php echo e(route('referral')); ?>" >Inform Musika about your Musika student's referral (e.g. friend, relative, or sibling)</a></small>
							</p>
                           </div>
						</div>		  
					</form>
...
<!--<script src="<?php echo e(asset('js/plugins/2.1.1/moment.min.js')); ?>"></script>
<script src="<?php echo e(asset('js/plugins/2.1.1/jquery.min.js')); ?>"></script>-->
...
<script src="<?php echo e(asset('js/plugins/2.1.1/fullcalendar.min.js')); ?>"></script>
<!--<script src="<?php echo e(asset('js/plugins/fullcalendar/fullcalendar.min.js')); ?>"></script>-->
<script src="<?php echo e(asset('js/plugins/2.1.1/fullcalendar.js')); ?>"></script>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\musikateachers\resources\views/submitNewEntry.blade.php ENDPATH**/ ?>