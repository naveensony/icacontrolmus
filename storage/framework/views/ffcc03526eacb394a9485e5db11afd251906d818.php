...
<?php $__env->startSection('title'); ?> Trial Lesson  <?php $__env->stopSection(); ?>
...
<div class="wrapper wrapper-content animated fadeInRight">
		...
		<form class="form-horizontal" name="dataDisplay" method="post" action="<?php echo e(url('updateStatus')); ?>" onsubmit="return chkForm(this);">
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-md-6">
                        <select  class="form-control" name='cid' onclick='checkVis(this.selectedIndex,"introinfo");' onchange='checkVis(this.selectedIndex,"introinfo");'>
                           <option></option>
                           <?php $__currentLoopData = $prospective_students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                           <?php if(!is_null($student->prospectiveStudent)): ?>
                           <option value="<?php echo e($student->connectId); ?>" <?php if(isset($connectId) && $connectId==$student->prospectiveStudent->studentId): ?> selected  <?php endif; ?> ><?php echo e($student->prospectiveStudent->firstName); ?> <?php echo e($student->prospectiveStudent->lastName); ?></option>
                           <?php endif; ?>
...
window.onload = function() {
	window.status='Musika Teacher <?php echo e($tname); ?>';
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\musikateachers\resources\views/newMail.blade.php ENDPATH**/ ?>