...
<fieldset class='rounded'><legend>Inquiries</legend>
	<div class='li'><span class='fl'><a href="control.php?page=inquiries">To email</a></span><span class='fr'><?php echo e($inquiries); ?></span></div><div class='clr'></div>
	<div class='li'><span class='fl'><a href="control.php?page=ch_inquiries_call&amp;search_new=Y&amp;istate=1">To call</a></span><span class='fr'><?php echo e($to_call); ?></span></div>
...
<fieldset class='rounded'><legend>Prospectives</legend>
	<div class='li'><span class='fl'><a href="control.php?page=send_prospectives" title='Prospectives to be sent out'>To be sent out</a></span><span class='fr'><?php echo e($prospectives); ?></span></div><div class='clr'></div>
	<div class='li'><span class='fl'><a href="control.php?page=teacher_student_request">Connection: To be made</a></span><span class='fr'><?php echo e($assignments); ?></span></div><div class='clr'></div>
</fieldset>
<fieldset class='rounded'><legend>Accounting</legend>
<?php echo $__env->make('system.tasks_teachers_no_rate', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

	<div class='li'><span class='fl'><a href="findNegs.php" title='Packages w/negative counts'>Packages with negative counts</a></span><span class='fr'><?php echo e($billing); ?></span></div><div class='clr'></div>
	<div class='li'>
		<span class='fl'><a href="control.php?page=cc_declined" title='Declined CCs'>Total declined CCs with all four emails sent</a></span>
		<span class='fr'><b><?php echo e($billingg['declined_all_four']); ?></b> with all 4 emails sent / <b><?php echo e($billingg['declined_total']); ?></b> total declined CCs</span>
	</div><div class='clr'></div>
	<div class='li'>
		<span class='fl'><a href="control.php?page=contested" title='Contested entries'>Contested entries</a></span>
		<span class='fr'><b><?php echo e($contested['open']); ?></b> ticket
			<?php if($contested['open'] != 1): ?>
			s
			<?php endif; ?>
			open, <b>
		<?php echo e($contested['need_action']); ?></b> ticket
			<?php if($contested['need_action'] != 1): ?>
				s need
			<?php else: ?> 
				needs
			<?php endif; ?> 
...
<fieldset class='rounded'><legend>Entries</legend>
	<div class='li'><span class='fl'><a href="control.php?page=other_entries" title='Entries marked as "Other"'>Total "Other" entries</a></span><span class='fr'><?php echo e($entriess['total_others']); ?></span></div><div class='clr'></div>
	<div class='li'><span class='fl'><a href="control.php?page=comments" title='&quot;Same Day&quot; cancellations w/comments'>"Same Day" comments to be approved</a></span><span class='fr'><?php echo e($entriess['to_approve']); ?></span></div><div class='clr'></div>
	<div class='li'><span class='fl'><a href="javascript:toggle_visible('tblNoEntries');" title='Toggle table view'>Teachers not logging entries for new student after 16 days</a> (open admissions created after 2008 may 1)</span><span class='fr'><?php echo e($TTO_CALL ?? 0); ?></span></div><div class='clr'></div>
...
<fieldset class='rounded'><legend>Assignments</legend>
	<div class='li'><span class='fl'><a href="javascript:toggle_visible('tblTeachersCall');" title='Toggle table view'>Teachers to be called regarding assignment</a></span><span class='fr'><?php echo e($ato_call ?? 0); ?></span></div><div class='clr'></div>
...
<fieldset class='rounded'><legend>Registration Followup</legend>
	<div class='li'>
		...
		<span class='fr'><b><?php echo e($NC_TO_CALL); ?></b> to be called / <b><?php echo e($nc_call ?? 0); ?></b> total</span>
	</div><div class='clr'></div>
</fieldset>
<fieldset class='rounded'><legend>Hiring</legend>
<?php echo $__env->make('system.tasks_interviews_content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</fieldset>
</div>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\musikateachers\resources\views/system/tasks.blade.php ENDPATH**/ ?>